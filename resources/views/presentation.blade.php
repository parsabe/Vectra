...
<head>
    ...
    <title>Vectra: The Quarantine Matrix — 15-Stage Scrollytelling Deck</title>
...
<body class="bg-black text-white no-select overflow-x-hidden font-sans relative">
    ...
    <div id="scroll-container" class="relative w-full h-[1500vh]">
        ...
        <div id="scroll-wrapper" class="fixed inset-0 w-full h-screen overflow-hidden z-0">
            ...
            <nav class="absolute right-6 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-3 pointer-events-none">
                @for ($i = 0; $i < 15; $i++)
            ...
            <div class="relative w-full h-full">
                ...
                <section id="section-1" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center floating-pane text-white">
                        <div class="lg:col-span-6 flex flex-col justify-center text-left">
                            <div class="font-mono text-[10px] text-cyan-400 tracking-[0.3em] uppercase mb-3 text-glow-cyan">// SECTION_01 // RELATED WORK FOUNDATIONS</div>
                            <h2 class="font-mono uppercase text-2xl md:text-3xl font-black mb-4">Mathematical Foundations</h2>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                                Mildenhall et al. (2020) proposed modeling physical environments as continuous 5D functions using a neural network to calculate density and emitted color. Volume density $\sigma$ dictates space opacity, while directional color is accumulated through differentiable numerical ray integration.
                            </p>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans text-justify">
                                Quality benchmarks rely on Peak Signal to Noise Ratio (PSNR) to audit pixel-wise variance against ground truth, and Structural Similarity Index Measure (SSIM) to check luminance, contrast, and structural covariance.
                            </p>
                        </div>
                        <div class="lg:col-span-6 flex flex-col gap-3 justify-center">
                            <div class="p-3 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-cyan-400 mb-1 tracking-wider uppercase">// Volume Rendering Integration:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                            ...
                            <div class="p-3 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-cyan-400 mb-1 tracking-wider uppercase">// Peak Signal to Noise Ratio:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                                    $$PSNR(I) = 10 \cdot \log_{10} \left( \frac{MAX(I)^2}{MSE(I)} \right)$$
                                </div>
                            </div>
                            <div class="p-3 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-cyan-400 mb-1 tracking-wider uppercase">// Structural Similarity:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                ...
                <section id="section-2" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        <div class="font-mono text-[10px] text-cyan-400 tracking-[0.3em] uppercase mb-4 text-glow-cyan">// VISUAL ARCHIVE // FIGURE 1</div>
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/1.png" alt="Figure 1" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 1: NeRF Scene Representation & Differentiable Volume Rendering</div>
                    </div>
                </section>
                ...
                <section id="section-3" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/6.png" alt="Figure 6" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 6: Evaluation Metrics and Perceptual Image Comparisons</div>
                    </div>
                </section>
                ...
                <section id="section-4" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center floating-pane text-white">
                        <div class="lg:col-span-6 flex flex-col justify-center text-left">
                            <div class="font-mono text-[10px] text-fuchsia-400 tracking-[0.3em] uppercase mb-3 text-glow-magenta">// SECTION_03 // SEMANTIC CONSISTENCY</div>
                            <h2 class="font-mono uppercase text-2xl md:text-3xl font-black mb-4 text-fuchsia-300 text-glow-magenta">DietNeRF and Semantic Regularization</h2>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                                Standard NeRF daemons suffer catastrophic geometry collapse when optimized under few-shot viewpoints. Without global constraints, $\mathcal{L}_{MSE}$ minimization leads to degenerate near-field "floaters" packed against virtual cameras.
                            </p>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans text-justify">
                                DietNeRF (Jain et al., 2021) bypasses this vulnerability by enforcing a semantic consistency loss. It compares high-level invariant representations of synthetic renders against pre-observed poses using normalised Vision Transformer (ViT) embeddings.
                            </p>
                        </div>
                        <div class="lg:col-span-6 flex flex-col gap-4 justify-center">
                            <div class="p-4 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-fuchsia-400 mb-1.5 tracking-wider uppercase">// Semantic Consistency L2 Loss:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                                    $$\mathcal{L}_{SC, \ell_2}(I, \hat{I}) = \frac{\lambda}{2} \| \phi(I) - \phi(\hat{I}) \|_2^2$$
                                </div>
                            </div>
                            <div class="p-4 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-fuchsia-400 mb-1.5 tracking-wider uppercase">// Cosine Similarity formulation:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                ...
                <section id="section-5" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/3.png" alt="Figure 3" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 3: DietNeRF Novel Views synthesized from sparse input DTU dataset</div>
                    </div>
                </section>
                ...
                <section id="section-6" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/2.png" alt="Figure 2" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 2: View Synthesis comparison on Realistic Synthetic Dataset</div>
                    </div>
                </section>
                ...
                <section id="section-7" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center floating-pane text-white">
                        <div class="lg:col-span-6 flex flex-col justify-center text-left">
                            <div class="font-mono text-[10px] text-yellow-400 tracking-[0.3em] uppercase mb-3 text-glow-yellow">// SECTION_05 // GENERATIVE 3D</div>
                            <h2 class="font-mono uppercase text-2xl md:text-3xl font-black mb-4 text-yellow-300 text-glow-yellow">Generative Gaussian Splatting</h2>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                                DreamGaussian (Tang et al., 2024) transitions generative 3D pipelines from neural fields to explicit 3D Gaussian nodes. Nodes track spatial coordinate center $x$, scaling $s$, rotation quaternion $q$, opacity $\alpha$, and diffuse color $c$.
                            </p>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans text-justify">
                                High-speed generation utilizes Score Distillation Sampling (SDS). Re-rendered 2D projections are guided by diffusion noise gradients to optimize parameter coordinates $\Theta$, before marching cubes extracts the polygonal mesh.
                            </p>
                        </div>
                        <div class="lg:col-span-6 flex flex-col gap-4 justify-center">
                            <div class="p-4 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-yellow-400 mb-1.5 tracking-wider uppercase">// Score Distillation Sampling (SDS) Loss:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                            ...
                            <div class="p-4 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5 text-left">
                                <div class="font-mono text-[9px] text-yellow-400 mb-1.5 tracking-wider uppercase">// Spatial Influence Density extraction:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                ...
                <section id="section-8" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/7.png" alt="Figure 7" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 7: Qualitative comparison on Image-to-3D algorithms</div>
                    </div>
                </section>
                ...
                <section id="section-9" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/13.png" alt="Figure 13" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 13: Sequential VRAM Lifecycle on restricted GPU VRAM ceiling</div>
                    </div>
                </section>
                ...
                <section id="section-10" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center floating-pane text-white">
                        <div class="lg:col-span-6 flex flex-col justify-center text-left">
                            <div class="font-mono text-[10px] text-cyan-400 tracking-[0.3em] uppercase mb-3 text-glow-cyan">// SECTION_07 // METHODOLOGY BLUEPRINTS</div>
                            <h2 class="font-mono uppercase text-2xl md:text-3xl font-black mb-4">Decoupled Spatial Architecture</h2>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                                The Vectra Protocol isolates client-side rendering from background inference. The browser renders 3D Gaussian hallways via <code>gsplat.js</code> and collision physics via <code>Cannon.js</code>. The backend Local GPU Forge coordinates U2Net, SDXL-Lightning, and TripoSR local models.
                            </p>
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                                <strong>Deep Splat Excavation (DBSE)</strong> solves occlusion: viewport raycasting defines a 3D bounding box intersecting the hallway splats, and a shader-level override sets their opacity values to zero in the fragment shader. 
                            </p>
                        </div>
                        <div class="lg:col-span-6 flex flex-col justify-center text-left">
                            <p class="leading-relaxed text-neutral-300 text-xs md:text-sm font-sans mb-4 text-justify">
                            ...
                            <div class="p-3.5 rounded-lg bg-neutral-950/20 backdrop-blur-sm border border-neutral-900/5">
                                <div class="font-mono text-[9px] text-cyan-400 mb-1 tracking-wider uppercase">// Client-Side Collision updates:</div>
                                <div class="math-block font-sans text-xs md:text-sm">
                ...
                <section id="section-11" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="w-full max-w-xl p-4 relative font-mono text-[9px] text-neutral-400 border border-neutral-900/10 rounded-xl bg-neutral-950/20 backdrop-blur-sm">
                            <div class="text-center text-glow-cyan text-[10px] uppercase font-bold tracking-widest mb-3">Vectra Spatial Processing Map</div>
                            ...
                            <div id="flow-node-details" class="p-3 bg-neutral-900/30 rounded-lg text-[9px] leading-relaxed text-neutral-400 mt-2 text-center">
                ...
                <section id="section-12" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/11.png" alt="Figure 11" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 11: Generative Extraction Pipeline (Scenario 1) Flowchart</div>
                    </div>
                </section>
                ...
                <section id="section-13" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center floating-pane">
                        ...
                        <div class="relative overflow-hidden bg-transparent rounded-xl border border-neutral-900/10 p-2 flex justify-center items-center max-w-[75vw] max-h-[70vh]">
                            <img src="/img/12.png" alt="Figure 12" class="max-w-full max-h-[60vh] object-contain rounded-lg shadow-2xl">
                        </div>
                        <div class="font-mono text-[9px] text-neutral-400 mt-4 text-center tracking-wide uppercase">// Figure 12: Deep Splat Excavation (DBSE) Frustum Raycasting & Masking</div>
                    </div>
                </section>

                <!-- SECTION 14: CONCLUSION & PORTAL LINK -->
                <section id="section-14" class="scrolly-section">
                    <div class="w-full max-w-5xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center floating-pane text-white">
                        ...
                        <div class="lg:col-span-7 flex flex-col justify-center text-left">
                            <div class="font-mono text-[10px] text-cyan-400 tracking-[0.3em] uppercase mb-3 text-glow-cyan">// CONCLUSION SUMMARY & PORTAL</div>
                            <h2 class="font-mono uppercase text-3xl md:text-4xl font-black mb-4">Conclusion</h2>
                            <p class="leading-relaxed text-neutral-300 text-sm md:text-base mb-4 font-sans text-justify">
                            ...
                            <p class="leading-relaxed text-neutral-300 text-sm md:text-base font-sans text-justify mb-6">
