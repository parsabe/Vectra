...
<head>
    ...
    <style>
        /* Force body scrollability overriding the global overflow: hidden in app.css */
        html, body {
        ...
        /* Radial glow overlay for card sheen reflection */
        .card-sheen {
            position: absolute;
            inset: 0;
        ...
        .card-sheen-magenta {
            ...
            background: radial-gradient(
                800px circle at var(--x, 0px) var(--y, 0px),
                rgba(240, 46, 170, 0.06),
                transparent 40%
            );
            z-index: 1;
        }

        /* 3D layers inside cards */
        .depth-layer {
...
<body class="bg-black text-neutral-200 select-none overflow-x-hidden font-sans relative">
    ...
    <header class="fixed top-4 left-4 right-4 z-40 bg-neutral-950/75 backdrop-blur-xl border border-cyan-900/30 rounded-xl p-4 flex justify-between items-center shadow-2xl pointer-events-auto">
    ...
    <main class="relative z-10 w-full min-h-screen px-4 md:px-12 flex flex-col items-center justify-start pointer-events-none">
        ...
        <section id="hero-section" class="w-full max-w-4xl min-h-screen flex flex-col justify-center items-center py-24 mb-[140vh] pointer-events-auto">
            <div class="card-tilt w-full bg-neutral-950/75 backdrop-blur-xl border border-cyan-500/20 hover:border-cyan-400/40 p-6 md:p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8),_0_0_20px_rgba(0,243,255,0.05)] transition-all duration-500">
                ...
                <div class="depth-layer">
                    ...
                    <p class="leading-relaxed text-neutral-300 text-sm md:text-base mb-8 font-sans">
        ...
        <section id="foundational-fields" class="w-full max-w-4xl min-h-screen flex flex-col justify-center items-center py-24 mb-[140vh] pointer-events-auto">
            <div class="card-tilt w-full bg-neutral-950/75 backdrop-blur-xl border border-cyan-500/20 hover:border-cyan-400/40 p-6 md:p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8),_0_0_20px_rgba(0,243,255,0.05)] transition-all duration-500">
                <div class="card-sheen"></div>
                <div class="depth-layer">
                    ...
                    <p class="leading-relaxed text-neutral-300 text-sm md:text-base mb-6 font-sans">
                    ...
                    <!-- Formula 1 -->
                    <div class="my-6 p-5 rounded-xl bg-black/60 border border-cyan-900/30 overflow-x-auto relative group">
                        <div class="font-mono text-[10px] text-cyan-500 mb-3">// Formula 1 (Volume Rendering)</div>
                        <div class="text-center py-3 text-glow-cyan text-lg md:text-xl">
                            $$\mathcal{C}(r)=\int_{t_{n}}^{t_{f}}T(t)\sigma(r(t))c(r(t),d)d~t$$
                        </div>
                        
                        <!-- Interactive Formula Breakdown -->
                        <div class="mt-4 pt-4 border-t border-cyan-900/20 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-mono text-cyan-500/80">
                            <div><span class="text-cyan-400">$\mathcal{C}(r)$</span> : Predicted optical ray payload</div>
                            <div><span class="text-cyan-400">$\int_{t_n}^{t_f}$</span> : Near & far clipping boundaries</div>
                            <div><span class="text-cyan-400">$T(t)$</span> : Cumulative ray transmittance</div>
                            <div><span class="text-cyan-400">$\sigma(r(t))$</span> : Localized volume density (opacity)</div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                        <div class="p-5 rounded-xl bg-black/60 border border-fuchsia-900/30 overflow-x-auto relative">
                            <div class="font-mono text-[10px] text-fuchsia-500 mb-3">// Formula 2 (PSNR)</div>
                            <div class="text-center py-3 text-glow-magenta text-base md:text-lg">
                                $$PSNR(I)=10\cdot log_{10}(\frac{MAX(I)^{2}}{MSE(I)})$$
                            </div>
                            <div class="mt-2 text-[10px] font-mono text-fuchsia-500/80 text-center">
                                $MAX(I)$: Peak pixel value | $MSE(I)$: Mean Squared Error
                            </div>
                        </div>
                        
                        <div class="p-5 rounded-xl bg-black/60 border border-fuchsia-900/30 overflow-x-auto relative">
                            <div class="font-mono text-[10px] text-fuchsia-500 mb-3">// Formula 3 (SSIM)</div>
                            <div class="text-center py-3 text-glow-magenta text-sm md:text-base">
                                $$SSIM(x, y) = \frac{(2\mu_x\mu_y + C_1)(2\sigma_{xy} + C_2)}{(\mu_x^2 + \mu_y^2 + C_1)(\sigma_x^2 + \sigma_y^2 + C_2)}$$
                            </div>
                            <div class="mt-2 text-[10px] font-mono text-fuchsia-500/80 text-center">
                                $\mu$: Mean | $\sigma$: Variance/Covariance | $C$: Constant
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="semantic-consistency" class="w-full max-w-4xl min-h-screen flex flex-col justify-center items-center py-24 mb-[140vh] pointer-events-auto">
            <div class="card-tilt w-full bg-neutral-950/75 backdrop-blur-xl border border-fuchsia-500/20 hover:border-fuchsia-400/40 p-6 md:p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8),_0_0_20px_rgba(240,46,170,0.05)] transition-all duration-500">
                <div class="card-sheen-magenta"></div>
                <div class="depth-layer">
                    ...
                    <!-- Formula 4 -->
                    <div class="my-6 p-5 rounded-xl bg-black/60 border border-fuchsia-900/30 overflow-x-auto relative">
                        <div class="font-mono text-[10px] text-fuchsia-500 mb-3">// Formula 4 (Semantic Consistency)</div>
                        <div class="text-center py-3 text-glow-magenta text-lg md:text-xl">
                            $$\mathcal{H}_{SC,l_{2}}(I,\hat{I})=\frac{\lambda}{2}||\phi(I)-\phi(\hat{I})||_{2}^{2}$$
                        </div>
                        <div class="mt-4 pt-4 border-t border-fuchsia-900/20 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-mono text-fuchsia-500/80">
                            <div><span class="text-fuchsia-400">$\phi(I)$</span> : Semantic embedding of ground-truth view</div>
                            <div><span class="text-fuchsia-400">$\phi(\hat{I})$</span> : Semantic embedding of synthesized view</div>
                            <div><span class="text-fuchsia-400">$\lambda$</span> : Consistency weight hyperparameter</div>
                            <div><span class="text-fuchsia-400">$l_2$</span> : Euclidean distance metric</div>
                        </div>
                    </div>
        ...
        <section id="gaussian-splatting" class="w-full max-w-4xl min-h-screen flex flex-col justify-center items-center py-24 mb-[140vh] pointer-events-auto">
            <div class="card-tilt w-full bg-neutral-950/75 backdrop-blur-xl border border-yellow-500/20 hover:border-yellow-400/40 p-6 md:p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8),_0_0_20px_rgba(234,179,8,0.05)] transition-all duration-500">
                <div class="card-sheen"></div>
                <div class="depth-layer">
                    ...
                    <div class="flex flex-col gap-4 my-6">
                        <div class="p-5 rounded-xl bg-black/60 border border-yellow-900/30 overflow-x-auto relative">
                            <div class="font-mono text-[10px] text-yellow-500 mb-3">// Formula 5 (SDS Loss for Image-to-3D)</div>
                            <div class="text-center py-3 text-glow-yellow text-sm md:text-base">
                            ...
                            <div class="mt-4 pt-4 border-t border-yellow-900/20 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-mono text-yellow-500/80">
                                <div><span class="text-yellow-400">$\Theta$</span> : Gaussian parameters array</div>
                                <div><span class="text-yellow-400">$w(t)$</span> : Timestep noise schedule weight</div>
                                <div><span class="text-yellow-400">$\epsilon_{\phi}$</span> : Diffusion model predicted noise</div>
                                <div><span class="text-yellow-400">$I_{RGB}^{p}$</span> : Rendered image at pose $p$</div>
                            </div>
                        </div>
                        
                        <div class="p-5 rounded-xl bg-black/60 border border-yellow-900/30 overflow-x-auto relative">
                            <div class="font-mono text-[10px] text-yellow-500 mb-3">// Formula 6 (Volumetric Density)</div>
                            <div class="text-center py-3 text-glow-yellow text-lg md:text-xl">
                                $$d(x)=\sum_{i}\alpha_{i}exp(-\frac{1}{2}(x-x_{i})^{T}\Sigma_{i}^{-1}(x-x_{i}))$$
                            </div>
                            <div class="mt-4 pt-4 border-t border-yellow-900/20 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-mono text-yellow-500/80">
                                <div><span class="text-yellow-400">$\alpha_i$</span> : Opacity of node $i$</div>
                                <div><span class="text-yellow-400">$x_i$</span> : Centroid of node $i$</div>
                                <div><span class="text-yellow-400">$\Sigma_i$</span> : Covariance (scaling/rotation)</div>
                                <div><span class="text-yellow-400">$d(x)$</span> : Cumulative spatial density</div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="methodology" class="w-full max-w-4xl min-h-screen flex flex-col justify-center items-center py-24 pb-32 pointer-events-auto">
            <div class="card-tilt w-full bg-neutral-950/75 backdrop-blur-xl border border-cyan-500/20 hover:border-cyan-400/40 p-6 md:p-10 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.8),_0_0_20px_rgba(0,243,255,0.05)] transition-all duration-500">
                ...
                <div class="depth-layer">
                    ...
                    <!-- Formula 7 -->
                    <div class="my-6 p-5 rounded-xl bg-black/60 border border-cyan-900/30 overflow-x-auto relative">
                        <div class="font-mono text-[10px] text-cyan-500 mb-3">// Formula 7 (Rotational Loss)</div>
                        <div class="text-center py-3 text-glow-cyan text-lg md:text-xl">
                            $$\mathcal{L}_{rot} = \frac{1}{K} \sum \sum w_{ij} ||q - q||^2$$
                        </div>
                        <div class="mt-4 pt-4 border-t border-cyan-900/20 grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-mono text-cyan-500/80">
                            <div><span class="text-cyan-400">$K$</span> : Normalization constant factor</div>
                            <div><span class="text-cyan-400">$w_{ij}$</span> : Neighboring connection weight</div>
                            <div><span class="text-cyan-400">$q$</span> : Rotation quaternion values</div>
                            <div><span class="text-cyan-400">$\mathcal{L}_{rot}$</span> : Regularized alignment penalty</div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Interactive 3D Card Tilt Effect Script
        document.addEventListener('DOMContentLoaded', () => {
            ...
            cards.forEach(card => {
                card.addEventListener('mousemove', (e) => {
                    ...
                    const rotateX = (-percentY * 6).toFixed(2); // Tilt up/down
                    const rotateY = (percentX * 6).toFixed(2);  // Tilt left/right
