...
function initThree() {
    ...
    carMesh = new THREE.InstancedMesh(carGeom, carMat, carCount);
    ...
    for (let i = 0; i < carCount; i++) {
        ...
        const laneY = 4 + Math.random() * 22;
        const startZ = -120 + Math.random() * 240;
...
document.addEventListener('DOMContentLoaded', () => {
    // Initialize Three.js once the DOM elements are ready
    initThree();
